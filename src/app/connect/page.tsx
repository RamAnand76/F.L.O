...
import { Github, ArrowRight, Loader2, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <motion.button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-zinc-500 hover:text-white transition-colors mb-6 ml-1 group"
        ...
        <motion.div 
          className="w-full p-8 bg-zinc-900/50 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl"
